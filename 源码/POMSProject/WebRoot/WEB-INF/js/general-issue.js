...
var array = {
	//客户管理-客户管理
	"shang-show" : {
		"load_URL" : "/POMSProject/publish/productOrder/orderList",
		"query_URL" : "",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
		...
		"place" : "",
		"is_equally" : "0",
		"data_names" : [ "orderID", "newspaperID", "customerID", "customerName", "orderType", "orderAddress", "orderNum", "salerID", "orderDate", "deliverDate", "deliverID","frequency","orderKeepTime"],
	},
	"khgl-khgl" : {
		"load_URL" : "/POMSProject/publish/customer/customerList",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/customer/customerRegister",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
		"is_equally" : "0",
		"data_names" : [ "customerID", "customerName", "customerPhone", "customerType" ]
	},
	...
	"spdg-xd1" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/productOrder/newOrder",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"spdg-td" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/productOrder/deleteOrder",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"spdg-zz" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/productOrder/changeAddress",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"spdg-yq" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/productOrder/postpone",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"spdg-xd2" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/productOrder/renewSubscription",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"dgbg-tdcx" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/orderChange/cancelDeleteOrder",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"dgbg-zzcx" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/orderChange/cancelChangeAddress",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"dgbg-yqcx" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/orderChange/cancelPostpone",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"jdgl-tscl" : {
		"load_URL" : "/POMSProject/publish/supervisionManage/complaintList",
		"query_URL" : "",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
	...
	"jdgl-bycl" : {
		"load_URL" : "/POMSProject/publish/supervisionManage/praiseList",
		"query_URL" : "",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
	...
	"jdgl-jycl" : {
		"load_URL" : "/POMSProject/publish/supervisionManage/suggestionList",
		"query_URL" : "",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
	...
	"jdgl-tjhz" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/supervisionManage/insertReceipt",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"fpgl-fpsz" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/invoice/invoiceManage",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"tdgl-xsd" : {
		"load_URL" : "",
		"query_URL" : "/POMSProject/publish/deliverManage/getOrderCount",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
	...
	"tdgl-ckd" : {
		"load_URL" : "/POMSProject/publish/query/promptList",
		"query_URL" : "",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
	...
	"cx-tdcx" : {
		"load_URL" : "",
		"query_URL" : "/POMSProject/publish/deliverManage/getDeliverArea",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
	...
	"cx-dhcx" : {
		"load_URL" : "/POMSProject/publish/query/customerList",
		"query_URL" : "",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
	...
	"fzyw-sqtz" : {
		"load_URL" : "/POMSProject/publish/assist/adviceList?isReaded=0",
		"query_URL" : "/POMSProject/publish/assist/adviceList",
		"add_URL" : "",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "3",
	...
	"fzyw-fstz" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/assist	/sendAdvice",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"fzyw-xgmm" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/assist/changePassword",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	"rsgl-ygxxsz" : {
		"load_URL" : "/POMSProject/publish/employeeManage/employeeList",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/employeeManage/newEmployee",
		"delete_URL" : "/POMSProject/publish/employeeManage/deleteEmployee",
		"update_URL" : "/POMSProject/publish/employeeManage/updateEmployee",
		"flag" : "2",
		"place" : "[2,3,4,7,8]",
		"is_equally" : "0",
		"data_names" : ["employeeID","employeeName","sex","age","stationID","departmentID","dutyName","phone"]
	},
	...
	"rsgl-ygzzsz" : {
		"load_URL" : "",
		"query_URL" : "",
		"add_URL" : "/POMSProject/publish/employeeManage/setEmployeeDuty",
		"delete_URL" : "",
		"update_URL" : "",
		"flag" : "0",
		"place" : "",
	...
	$(".sub-list").find("ul>li>a").click(function() {
		...
		$(".main-right").load(href, function() {
			...
			$(document).on("click", ".isReaded-btn", function() {
				...
				//单页面事件 就在这里写了
				$.ajax({
					url : "/POMSProject/publish/assist/setAdviceReaded", //此处填确认通知的URL
					type : "get",
					data : {
						"adviceID" : adviceID
					}, //通知id 此处id通过页面获得 页面显示id号 同时上面is_equally == "0"的 data_names参数要包括id =="1"的就不用了，传回来的data有id
					dataType : "json",
			...
			$(document).on("scroll", function() {
				...
				if (scrollTop + windowHeight >= scrollHeight) {
					page++;
					if (type == 0) {
//						alert(load_URL+" "+flag+" "+place+" "+is_equally+" ");
//						alert(page);	
						load(load_URL, flag, place, is_equally, data_names, page);
					} else if (type == 1) {
						query_1(query_URL, search_json, flag, place, is_equally, data_names, page);
					}
	...
	if (data.size > 0) {
		...
		for (var i = 0; i < data.size; i++) {
			...
			var editStat = "<button type = 'button' class = 'btn btn-info' onclick='return beginEdit(this," + place + "," + flag + ");'>" +
				"<span class = 'glyphicon glyphicon-edit edit_btn'></span>编辑</button>";
...
//查询ajax
var query_1 = function(query_URL, json, flag, place, is_equally, data_names, page) {
	if (query_URL == "") {
		return;
	}
	if (json.isReaded == 1) {
...
function beginEdit() {
	...
	for (var i = 0; i < columeArr.length; i++) {
		...
		// // 
		var editnode = childrennode[columeArr[i] - 1];
		editnode.innerHTML = "<input class='edit_input' id = 'waitEdit" + idOfWaitEdit + "' type= 'text 'value='" + editnode.innerText + "'>";
		idOfWaitEdit++;
	}
	 ...
	 *编辑按钮变为完成和取消按钮
	 */
	arguments[0].parentNode.innerHTML = "<button type=\"button\" class=\"btn btn-info submit_btn \" onclick=\"return submitChange(this,[" + indexOfColumesArrStr + "]," + arguments[2] + ")\">\n" +
