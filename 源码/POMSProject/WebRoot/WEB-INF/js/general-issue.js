            ...
            $(document).on("scroll",function() {
                ...
                if (scrollTop + windowHeight >= scrollHeight) {
                    ...
                    if (type == 0) {
                        ...
                        query_1(query_URL, search_if, flag, place, is_equally, data_names, page);
                    }
...
function beginEdit() {
    ...
    arguments[0].parentNode.innerHTML =
        "<button type=\"button\" class=\"btn btn-info submit_btn \" onclick=\"return submitChange(this,[" + indexOfColumesArrStr + "]," + arguments[2] + ")\">\n" +
