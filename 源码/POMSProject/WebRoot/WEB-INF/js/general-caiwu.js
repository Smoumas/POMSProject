var array = {
    "bkcwgl-bksdtj": {
        "load_URL": "",
        "query_URL": "/POMSProject/finance/news/sumAccount",
        "add_URL": "",
        "delete_URL": "",
        "update_URL": "",
        "flag": "0",
        "place": "",
        "is_equally": "0",
        "data_names": ["stationID","cash","check","coupon"]
    },
    "bkcwgl-bktdtj": {
        "load_URL": "/POMSProject/finance/news/deliverAccount",
        "query_URL": "",
        "add_URL": "",
        "delete_URL": "",
        "update_URL": "",
    ...
    "fpgl-fpdjycx": {
        "load_URL": "/POMSProject/finance/invoice/queryInvoice",
        "query_URL": "",
        "add_URL": "/POMSProject/finance/invoice/registerInvoice",
        "delete_URL": "",
        "update_URL": "",
        "flag": "0",
        "place": "",
    ...
    "fpgl-fpff": {
        "load_URL": "/POMSProject/finance/invoice/queryInvoice",
        "query_URL": "",
        "add_URL": "/POMSProject/finance/invoice/grantInvoice",
        "delete_URL": "",
        "update_URL": "",
        "flag": "0",
        "place": "",
    ...
    "bkcwgl-fpthdj": {
        "load_URL": "/POMSProject/finance/invoice/queryInvoice",
        "query_URL": "",
        "add_URL": "/POMSProject/finance/invoice/returnInvoice",
        "delete_URL": "",
        "update_URL": "",
        "flag": "0",
        "place": "",
    ...
    //大客户交款 addurl为交款提交的servlet的url
    "dkhgl-dkhjk": {
        "load_URL": "/POMSProject/finance/bigCustomer/queryAll",
        "query_URL": "",
        "add_URL": "/POMSProject/finance/bigCustomer/updatePaymentState",
        "delete_URL": "",
        "update_URL": "",
        "flag": "0",
        "place": "",
    ...
    //大客户欠款查询
    "dkhgl-dkhqkcx": {
        "load_URL": "/POMSProject/finance/bigCustomer/queryDebt",
        "query_URL": "",
        "add_URL": "",
        "delete_URL": "",
        "update_URL": "",
        ...
        "place": "",
        "is_equally": "0",
        "data_names": ["orderID", "newspaperID", "customerID", "stationID", "orderDate", "paymentType", "paymentState"]
    },
    "rsgl-ygxxsz": {
        "load_URL": "/POMSProject/finance/staff/employeeList",
        "query_URL": "",
        "add_URL": "/POMSProject/finance/staff/newEmployee",
        "delete_URL": "/POMSProject/finance/staff/deleteEmployee",
        "update_URL": "/POMSProject/finance/staff/updateEmployee",
        "flag": "2",
        "place": "[2,3,4,6,7,8]",
        "is_equally": "1",
        "data_names": null
    ...
    "rsgl-czyqxsz": {
        "load_URL": "/POMSProject/finance/assist/queryAllOperator",
        "query_URL": "",
        "add_URL": "",
        "delete_URL": "",
        "update_URL": "/POMSProject/finance/assist/updateLevel",
        "flag": "1",
        "place": "[3]",
        "is_equally": "1",
        "data_names": null
    ...
    "fzyw-sqtz": {
        "load_URL": "/POMSProject/finance/assist/adviceList?isReaded=0",
        "query_URL": "/POMSProject/finance/assist/adviceList",
        "add_URL": "",
        "delete_URL": "",
        "update_URL": "",
        "flag": "3",
    ...
    "fzyw-fstz": {
        "load_URL": "",
        "query_URL": "",
        "add_URL": "/POMSProject/finance/assist/sendAdvice",
        "delete_URL": "",
        "update_URL": "",
        "flag": "0",
        "place": "",
    ...
    "fzyw-xgmm": {
        "load_URL": "",
        "query_URL": "",
        "add_URL": "/POMSProject/finance/assist/changePassword",
        "delete_URL": "",
        "update_URL": "",
        "flag": "0",
        "place": "",
...
//            	parent.remove();
                //单页面事件 就在这里写了
                $.ajax({
                    url: "/POMSProject/finance/assist/setAdviceReaded", //此处填确认通知的URL
                    type: "get",
            ...
            if (is_equally == "1") {
                for (var key in oneData) {
                  ...
                  //将key数字转换为中文
                    ...
                    console.log(oneData[key]=="null");
                    if(oneData[key] == null){
                    	console.log('fffffffffffffffffffdas');
                    }
                    if(oneData[key] == null){
                    	console.log("isNull");
